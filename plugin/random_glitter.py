...
def load_plugin(update_lamps, num_lamps, lamps):
    return RandomGlitter(update_lamps, num_lamps, lamps)

class RandomGlitter(object):
    ...
    def init(self, lamps):
        bc = self.base_color
        while bc == self.base_color:
            bc = COLOR_WHEEL1[random.randrange(0, len(COLOR_WHEEL1))]
        self.base_color = bc
        return
